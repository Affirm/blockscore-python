...
class TestWatchlistAPI(unittest.TestCase):
    ...
    def test_create_body(self):
        ...
        self.assertDictEqual({
            ...
            'first_name': self.test_identity['name']['first'],
            'middle_name': self.test_identity['name']['middle'],
            'last_name': self.test_identity['name']['last'],
            ...
            'address_state': self.test_identity['address']['state'],
